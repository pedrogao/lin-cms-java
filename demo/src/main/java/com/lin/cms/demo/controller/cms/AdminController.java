...
public class AdminController {
    ...
    public CommonResult updateGroup(@PathVariable @PositiveOrZero(message = "id必须正整数") Long id,
    ...
    public CommonResult deleteGroup(@PathVariable @PositiveOrZero(message = "id必须正整数") Long id) {
